...
Das ist nicht nur eine Absprache: `tests/conftest.py` sperrt die echte httpx-Transportschicht für die ganze Testsitzung. Ein Test, der wirklich ins Netz will, bekommt eine Exception. `tests/test_no_network.py` prüft, dass die Sperre greift.
