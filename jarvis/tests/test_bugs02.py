...
#
# Die fuenf Tests, die hier standen, pruefen die Klasse `Beobachter`. Die ist
# mit FIX-04 Schritt 3 ersatzlos entfallen - damit ist der Fund nicht
# "repariert", sondern gegenstandslos: es gibt keinen Thread mehr, der pro
# Datei startet, keine Timer-Tabelle, die waechst, und keinen stillen
# Indexverlust unter Last.
#
# Was an ihre Stelle getreten ist, prueft `tests/test_fix04.py`:
# `frisch_halten` zieht beim Lesen nach, was neu, geaendert oder geloescht
# ist - in EINEM Aufruf, ohne Nebenlaeufigkeit.
#
# Die Messung, die den Fund belegt hat, steht in docs/BUGS-01.md und im
# Commit 229ecfc. Sie ist nicht verloren, nur nicht mehr ausfuehrbar.
